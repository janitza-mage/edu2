        ...
        instantiate(): React.ReactElement {
            return <ProblemAccordion>
                ...
                <ProblemAccordionSection title={"Tipp 2"}>
                    <p>Fange für den Induktionsschritt mit der Summe bis {mathSpan("(n+1)")} an. Spalte
                        den {mathSpan("(n+1)")}-Term ab und wende dann die schon bewiesene Aussage
                        für {mathSpan("n")} auf die restliche Summe an.</p>
                </ProblemAccordionSection>
...
export const summenSubtree: ContentNode = {
    id: "summen",
    name: "Summenformeln",
    type: "folder",
    children: [
        ...
        summeAufgabe("summe-gerade-quadratzahlen", "Summe der ersten geraden n Quadratzahlen", "#sum_{i=1}^{n}(2i)^2 = #frac{2}{3}n(n+1)(2n+1)",
            "#sum_{i=1}^{1}(2i)^2", "#frac{2}{3}#cdot1#cdot(1+1)(2#cdot1+1)", "4",
            "#sum_{i=1}^{n}(2i)^2 = #frac{2}{3}n(n+1)(2n+1) #Rightarrow## #sum_{i=1}^{n+1}(2i)^2 = #frac{2}{3}(n+1)(n+2)(2(n+1)+1)",
            [
                "#sum_{i=1}^{n+1}(2i)^2",
                "= (#sum_{i=1}^{n}(2i)^2) + (2(n+1))^2",
                "= #frac{2}{3}n(n+1)(2n+1) + 4(n+1)^2",
                "= #frac{2}{3}(n+1)(n(2n+1) + 6(n+1))",
                "= #frac{2}{3}(n+1)(2n^2 + n + 6n + 6)",
                "= #frac{2}{3}(n+1)(2n^2 + 7n + 6)",
                "= #frac{2}{3}(n+1)(n+2)(2n+3)",
                "= #frac{2}{3}(n+1)(n+2)(2(n+1)+1)",
            ],
        ),
