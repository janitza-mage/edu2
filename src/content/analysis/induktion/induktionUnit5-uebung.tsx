...
export const induktionUnit5 = createSteppedUnit("induktion-uebung", "Übung", () => [
    createReadStep({
        content: <>
            ...
            <p><CenterInline>{mathInlineBlock("#sum_{i=1}^n(i) = #frac{n(n+1)}{2}", 12)} für {mathSpan("n#in #N")}</CenterInline></p>
    ...
    createChoiceStep({
        ...
        items: [
            {correct: true, label: mathSpan("#sum_{i=1}^1(i) = #frac{1(1+1)}{2}")},
    ...
    createChoiceStep({
        ...
        items: [
            {correct: false, label: mathSpan("#sum_{i=1}^1(i) = #frac{1(1+1)}{2}")},
